...
def menu_event ():
    ...
    if pos is not None:
        ...
        if current_screen in ["parameter_on", "parameter_off"]:
            ...
            if (current_screen == "parameter_off") & (music_on_button_rect.collidepoint(pos)):
                music = True
            current_screen = "menu"
            pygame.display.flip()
            pygame.display.set_caption("Dunk & Degree - Menu")
            ...
            if avatar == 1 :
                if avatar_2_button_rect.collidepoint(pos):
                    avatar = 2
                ...
                if avatar_1_button_rect.collidepoint(pos):
                    avatar = 1
                if avatar_3_button_rect.collidepoint(pos):
                    avatar = 3
            elif avatar == 3 :
                if avatar_2_button_rect.collidepoint(pos):
                    avatar = 2
            ...
            #GESTION OF THE BALL
            if ball == 1 :
                if blue_ball_button_rect.collidepoint(pos):
                    ball = 2
